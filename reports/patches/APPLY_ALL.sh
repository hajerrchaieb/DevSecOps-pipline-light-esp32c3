...
echo '[AutoFix] → fix_qemu_fault_runner.py.patch'
if git apply --check --directory="$ESP_MAIN" "/home/runner/work/DevSecOps-pipline-light-esp32c3/DevSecOps-pipline-light-esp32c3/reports/patches/fix_qemu_fault_runner.py.patch" 2>/dev/null; then
  git apply --directory="$ESP_MAIN" "/home/runner/work/DevSecOps-pipline-light-esp32c3/DevSecOps-pipline-light-esp32c3/reports/patches/fix_qemu_fault_runner.py.patch"
  APPLIED=$((APPLIED+1))
  echo '  ✅ Applied'
else
  echo '  ⚠️  Skipped (already applied or conflicts)'
